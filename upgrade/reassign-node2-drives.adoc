...
summary: Dopo aver convertito AFF A150, AFF A220 o FAS2820 node2 in uno shelf di dischi e averlo collegato a node4, si riassegnano i dischi che in precedenza appartenevano a node2 a node4. 
---
...
[role="lead"]
Riassegnare le unità che in precedenza appartenevano ad AFF A150, AFF A220 o FAS2820 nodo2 al nodo4.

.Prima di iniziare
Verificare che il nodo 3 e il nodo 4 siano entrambi in standby al prompt DEL CARICATORE.

.Fasi
Eseguire questi passaggi su node4.
...
link:migrate-aggregates-epsilon-lifs.html["Migrazione di aggregati di dati, epsilon e LIF dal nodo 1 al node4"]
