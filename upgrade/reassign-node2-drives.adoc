...
summary: Dopo aver convertito node2 in uno shelf di dischi e averlo collegato a node4, si riassegnano i dischi che in precedenza appartenevano a node2 a node4. 
---
...
[role="lead"]
Riassegna le unità che in precedenza appartenevano a node2 a node4.
