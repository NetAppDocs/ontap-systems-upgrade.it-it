...
.Fasi
. Accendete l'alimentazione del nodo3 e quindi premete immediatamente Ctrl-C nel terminale della console per accedere al prompt LOADER.
+
...
+
Inserisci nome utente/password, se applicabile, oppure seleziona Invio per continuare.
