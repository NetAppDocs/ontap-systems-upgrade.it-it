...
summary: 'Se si esegue l"aggiornamento tramite spostamento di volumi, si preparano i nodi originali e si uniscono i nuovi nodi al cluster. Si spostano i volumi nei nuovi nodi, si configurano i LIF e si rimuovono i nodi originali dal cluster. L"aggiornamento tramite spostamento di volumi è una procedura non distruttiva.' 
---
= Scopri come eseguire l'aggiornamento spostando i volumi
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
