...
[role="lead"]
Converti node2 in uno shelf di dischi e connettilo a node4 prima di riassegnare i dischi da node2 a node4. Node1 e node2 sono i controller all'interno dello shelf di dischi.
