...
* link:upgrade_aff_a250_to_aff_a400_ndu_upgrade_workflow.html["Scopri la conversione di AFF A250 in uno shelf di dischi e lo spostamento dello storage su AFF A400"] (procedura non distruttiva)
* link:convert-to-drive-shelf.html["Aggiorna da AFF A150, AFF A220 o FAS2820 convertendolo in uno shelf di dischi"] (procedura non distruttiva)
