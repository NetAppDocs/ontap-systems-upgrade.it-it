...
summary: 'Per completare l"aggiornamento, collegare node3 a node4 e quindi migrare le interfacce logiche dati (LIF) e gli aggregati dati su node4 a node3.' 
---
...
[role="lead"]
Per completare l'aggiornamento, collegare node3 a node4 e quindi migrare le interfacce logiche dati (LIF) e gli aggregati dati su node4 a node3.
