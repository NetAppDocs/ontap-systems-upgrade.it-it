...
[role="lead"]
Migrare gli aggregati di dati, epsilon e le interfacce logiche (LIF) su AFF A150, AFF A220 o FAS2820 node1 a node4.
...
link:convert-node1-to-drive-shelf.html["Converti il node1 in uno shelf di dischi e connettiti al node3"]
