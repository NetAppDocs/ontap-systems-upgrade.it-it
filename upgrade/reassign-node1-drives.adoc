...
summary: Dopo aver convertito node1 in uno shelf di dischi e averlo collegato a node3, si riassegnano i dischi che in precedenza appartenevano a node1 a node3. 
---
...
[role="lead"]
Riassegna le unità precedentemente assegnate a node1 a node3.
