...
+
Sia il nuovo aggregato che il vecchio aggregato da cui viene spostato il volume devono trovarsi nello stesso SVM.
...
link:upgrade-move-lifs-to-new-nodes.html["Spostamento delle LIF dati non SAN e delle LIF di gestione cluster nei nuovi nodi"]
