...
summary: 'Scopri come utilizzare la riallocazione degli aggregati per aggiornare l"hardware dei controller AFF, ASA o FAS.' 
---
= Inizia da qui: scegli una procedura di aggiornamento ARL per l'hardware del controller AFF, ASA o FAS
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Puoi aggiornare l'hardware del controller AFF, ASA o FAS senza interruzioni utilizzando la riallocazione aggregata (ARL). Per altri metodi di aggiornamento dell'hardware del controller, vedi link:../upgrade/upgrade-decide-to-use-this-guide.html["Eseguire l'upgrade spostando volumi o storage"].
...
== Aggiorna ai sistemi introdotti in ONTAP 9.15.1 o versioni successive

Se il tuo scenario di aggiornamento è elencato nella seguente matrice dei sistemi supportati, vai a link:../upgrade-arl-auto-app-9151/index.html["Usa i comandi "system controller replace" per eseguire l'aggiornamento all'hardware del controller introdotto in ONTAP 9.15.1 o versioni successive"] per avviare la procedura di aggiornamento.
...
| AFF A70 | AFF A90 | 9.18.1 e versioni successive 


| AFF A30 | AFF A50 | 9.18.1 e versioni successive 


| AFF A20 | AFF A30, AFF A50 | 9.18.1 e versioni successive 


| AFF C30 | AFF C60 | 9.18.1 e versioni successive 


| FAS70 | FAS90 | 9.18.1 e versioni successive 
