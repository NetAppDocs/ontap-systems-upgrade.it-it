...
** Se node3 non dispone di una scheda o di porte integrate, saltare <<Controllare e configurare le porte UTA/UTA2 sul nodo 3>>E tornare a _Install e boot node3_ e riprendere il link:install_boot_node3.html#step7["Fase 7"].
...
| È un sistema V-Series o dispone di software di virtualizzazione FlexArray ed è collegato agli array di storage | Tornare a _Install e fare il boot node3_ e riprendere da link:install_boot_node3.html#step7["Fase 7"]. 
|===
