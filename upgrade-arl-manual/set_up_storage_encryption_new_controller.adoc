...
summary: Se necessario, configurare la crittografia dello storage, installare i certificati SSL e configurare i server di gestione delle chiavi durante un aggiornamento ARL manuale sui controller che eseguono ONTAP 9.7 o versioni precedenti. 
---
