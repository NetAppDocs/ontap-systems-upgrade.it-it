...
WARNING: Se il nodo 1 si trova nello stesso chassis del nodo 2, non spegnere lo chassis utilizzando l'interruttore di alimentazione o tirando il cavo di alimentazione.  In tal caso, il nodo 2, che fornisce i dati, non funzionerà.
...
. Facoltativamente, decommissionare node1 al termine dell'aggiornamento. Vedere link:decommission_old_system.html["Decommissionare il vecchio sistema"].
