...
|===
^1^ l'aggiornamento sostituendo il modulo controller comporta lo spostamento di tutte le connessioni dal vecchio al modulo controller sostitutivo.
^2^ l'aggiornamento mediante lo scambio di controller e moduli NVRAM comporta lo spostamento solo della console e delle connessioni di gestione.
