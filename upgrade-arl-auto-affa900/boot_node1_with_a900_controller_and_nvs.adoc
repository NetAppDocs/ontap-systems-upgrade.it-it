...
[cols="35,65"]
|===
| Vecchio controller node1 | Moduli di sistema node1 sostitutivi 
...
.. Controllare e ripristinare i bootargs di crittografia dello storage indicati nella <<A900_boot_node1,Fase 1>>.
