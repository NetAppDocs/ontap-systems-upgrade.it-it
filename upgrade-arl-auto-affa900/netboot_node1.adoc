...
. Attendere che node1 sia ora in esecuzione sul modulo controller ASA A900, AFF A900 o FAS9500 per l'avvio e visualizzare le opzioni del menu di avvio come mostrato di seguito:
+
[listing]
----
