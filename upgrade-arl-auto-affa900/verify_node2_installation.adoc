...
summary: 'Verificare l"installazione del nodo 2 con il modulo controller AFF A900 e il modulo NVRAM.' 
---
...
[role="lead"]
Verificare l'installazione del nodo 2 con il controller AFF A900 o FAS9500 e i moduli NVRAM. Poiché non sono state apportate modifiche alle porte fisiche, non è necessario mappare le porte fisiche dal vecchio nodo 2 al nodo sostituz.2.

.A proposito di questa attività
Dopo aver avviato il nodo 1 con il modulo controller AFF A900 o FAS9500, è necessario verificare che sia installato correttamente. È necessario attendere che node2 si unisca al quorum e quindi riprendere l'operazione di sostituzione del controller.
