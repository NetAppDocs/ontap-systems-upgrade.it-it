...
summary: 'Il sistema potrebbe bloccarsi (riavvio, panico o ciclo di alimentazione) durante diverse fasi durante l"aggiornamento di un AFF A700 a un AFF A900.' 
---
