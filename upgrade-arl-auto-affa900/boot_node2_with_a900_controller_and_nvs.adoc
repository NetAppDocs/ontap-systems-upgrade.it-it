...
summary: Punto di avvio2 con il modulo controller AFF A900 e il modulo NVRAM. 
---
= Punto di avvio2 con controller AFF A900 o FAS9500 e moduli NVRAM
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Node2 con il controller AFF A900 o FAS9500 e i moduli NVRAM è ora pronto per l'aggiornamento. Un aggiornamento da AFF A700 a AFF A900 o da FAS9000 a FAS9500 sostituendo il controller e i moduli NVRAM comporta lo spostamento solo della console e delle connessioni di gestione. In questa sezione vengono fornite le procedure necessarie per l'avvio del nodo 2 con il controller AFF A900 o FAS9500 e i moduli NVRAM.
...
. Riassegnare i dischi AFF A700 node2 a AFF A900 node2 immettendo "22/7" e selezionando l'opzione nascosta `boot_after_controller_replacement` quando il nodo si arresta nel menu di boot.
+
