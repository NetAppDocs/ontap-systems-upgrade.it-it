...
summary: Verificare che le LIF dei dati NAS di node2 sul node1 vengano ricollocate dal node1 al node2 durante un aggiornamento da AFF A700 a AFF A900. 
---
...
[role="lead"]
Dopo aver verificato la configurazione di rete sul nodo 2 e prima di spostare gli aggregati dal nodo 1 al nodo 2, è necessario verificare che le LIF dei dati NAS appartenenti al nodo 2 che sono attualmente sul nodo 1 vengano ricollocate dal nodo 1 al nodo 2. È inoltre necessario verificare che le LIF SAN esistano sul nodo 2.
...
--
+
Dopo aver eseguito questi controlli, il sistema ricolloca gli aggregati non root e i dati LIF NAS in node2, che è ora in esecuzione sul controller AFF A900 o FAS9500.
