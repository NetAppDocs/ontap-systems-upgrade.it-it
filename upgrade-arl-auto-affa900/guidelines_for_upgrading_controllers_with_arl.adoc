...
Se è stato ricevuto un nuovo AFF A30, AFF A50, AFF A70, AFF A90, AFF A150, AFF A900, AFF C30, AFF C60, AFF C80, FAS2820 o FAS9500 come sistema completo, incluso un nuovo chassis, fare riferimento al link:other_references.html["Riferimenti"]collegamento ai comandi _use "system controller replace" (utilizza sostituzione controller di sistema) per aggiornare l'hardware del controller che esegue ONTAP 9,8 o versioni successive.
