...
| Ho un sistema integrato e voglio aggiornarlo sostituendo solo il modulo controller, mantenendo lo chassis e i dischi esistenti? | link:upgrade-arl-auto-in-chassis/index.html["Aggiorna utilizzando ARL, mantenendo lo stesso chassis e gli stessi dischi"]. 
