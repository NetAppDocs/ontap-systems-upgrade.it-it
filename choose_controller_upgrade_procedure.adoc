...
* link:upgrade/upgrade-decide-to-use-this-guide.html["Sposta storage"]
+
È possibile effettuare l'aggiornamento senza interruzioni da un AFF A250 a un AFF A400 o da un FAS2820 a un sistema sostitutivo convertendo i nodi originali in ripiani unità, quindi collegando i ripiani unità ai nodi sostitutivi per spostare l'archiviazione integrata.
