...
Dopo aver verificato la presenza di errori di configurazione di MetroCluster, link:verify_switchover_healing_switchback.html["verificare switchover, healing e switchback"].
