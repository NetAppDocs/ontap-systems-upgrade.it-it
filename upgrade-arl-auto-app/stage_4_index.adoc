...
[role="lead"]
Durante la fase 4, è possibile spostare aggregati non root e LIF dati NAS da node2 a node3. È necessario registrare le informazioni necessarie sul node2 per utilizzarle più avanti nella procedura, quindi dismettere il node2.
