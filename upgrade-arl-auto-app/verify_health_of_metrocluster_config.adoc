...
Dopo aver verificato lo stato della configurazione MetroCluster, link:check_for_metrocluster_config_errors.html["verificare la presenza di errori di configurazione MetroCluster"].
