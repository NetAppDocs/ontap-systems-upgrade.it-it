...
+
Se si sta eseguendo l'aggiornamento a A800, andare a link:reassign-node2-disks-to-node4.html#reassign-node2-node4-app-step9["Riassegnare i dischi del nodo 2 al nodo 4, fase 9"].
