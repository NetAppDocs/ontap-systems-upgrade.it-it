...
summary: 'Risolvere i problemi di riposizionamento degli aggregati che potrebbero verificarsi durante l"utilizzo `system controller replace` Comandi per aggiornare i controller che eseguono ONTAP 9.8 o versioni successive.' 
---
