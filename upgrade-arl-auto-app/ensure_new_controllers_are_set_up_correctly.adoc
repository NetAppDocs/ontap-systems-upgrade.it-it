...
+
Fare riferimento a link:other_references.html["Riferimenti"] per collegarsi al _System Administration Reference_ per informazioni sugli SP e all'_ONTAP 9 Command reference_ per informazioni dettagliate sul comando di sistema  `service-processor network modify`.
...
Dopo aver verificato che i nuovi controller siano configurati correttamente, link:set_up_storage_encryption_new_module.html["Configurare la crittografia dell'archiviazione sul nuovo modulo controller"].
