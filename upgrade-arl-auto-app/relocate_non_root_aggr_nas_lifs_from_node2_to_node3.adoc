...
Dopo aver spostato gli aggregati non root e i LIF dei dati NAS dal nodo2 al nodo3, link:relocate-failed-or-vetoed-aggr-node3.html["spostare aggregati non riusciti o rifiutati"].
