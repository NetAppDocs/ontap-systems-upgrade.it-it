...
Se le porte fisiche sul nodo2 non corrispondono direttamente alle porte fisiche sul nodo4, la sezione successiva <<restore_network_configuration_on_node4,Ripristinare la configurazione di rete sul nodo 4>> deve essere utilizzata per riparare la connettività di rete.
...
Dopo aver verificato l'installazione di node4, link:restore_key-manager_config_node4.html["ripristinare la configurazione del key-manager sul nodo4"].
