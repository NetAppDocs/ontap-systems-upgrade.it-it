...
Dopo aver spostato gli aggregati non root e i LIF di dati NAS di proprietà del node1 al node2, link:relocate-failed-or-vetoed-aggr-node2.html["spostare aggregati non riusciti o rifiutati"].
