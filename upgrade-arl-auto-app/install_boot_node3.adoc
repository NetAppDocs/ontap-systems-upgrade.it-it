...
+
Se non si dispone di una configurazione FC o UTA/UTA2, eseguire link:reassign-node2-disks-to-node4.html#reassign-node1-node3-app-step1["Riassegnare node1 dischi a node3, passaggio 1"] questa operazione in modo che node3 sia in grado di riconoscere i dischi di node1.
