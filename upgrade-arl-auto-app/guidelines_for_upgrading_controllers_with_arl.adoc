...
Dopo aver esaminato le linee guida per l'aggiornamento dei controller con ARL, link:verify_health_of_metrocluster_config.html["verificare lo stato della configurazione MetroCluster"].
