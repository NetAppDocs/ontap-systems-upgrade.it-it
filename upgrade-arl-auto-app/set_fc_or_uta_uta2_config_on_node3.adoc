...
. [[step14]]avviare il nodo nel menu di avvio eseguendo `boot_ontap menu`. Se si sta eseguendo l'aggiornamento a un sistema AFF A800, visitare il sito link:reassign-node1-disks-to-node3.html#reassign-node1-node3-app-step9["Riassegnare node1 dischi a node3, passaggio 9"].
