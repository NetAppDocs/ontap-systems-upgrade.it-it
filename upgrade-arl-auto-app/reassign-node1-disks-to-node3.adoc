...
.Fasi
. Andare al menu di avvio e utilizzando 22/7, selezionare l'opzione nascosta `boot_after_controller_replacement` . Al prompt, immettere node1 per riassegnare i dischi di node1 a node3, come nell'esempio seguente.
+
