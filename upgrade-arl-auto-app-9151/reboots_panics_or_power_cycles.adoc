...
summary: 'Il sistema potrebbe bloccarsi – riavviarsi, andare in crash o eseguire un ciclo di alimentazione – durante diverse fasi dell"aggiornamento ai controller introdotti in ONTAP 9.15.1 o versioni successive usando  `system controller replace` comandi.' 
---
