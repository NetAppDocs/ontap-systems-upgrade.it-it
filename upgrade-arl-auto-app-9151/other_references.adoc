...
| link:https://docs.netapp.com/us-en/ontap-cli-9131/index.html["Comandi di ONTAP 9.13.1: Guida alla pagina"^] | Descrive la sintassi e l'utilizzo dei comandi ONTAP 9.13.1 supportati. 


| link:https://docs.netapp.com/us-en/ontap-cli-9141/index.html["Comandi di ONTAP 9.14.1: Guida alla pagina"^] | Descrive la sintassi e l'utilizzo dei comandi ONTAP 9.14.1 supportati. 


| link:https://docs.netapp.com/us-en/ontap-cli/index.html["Comandi di ONTAP 9.15.1: Guida alla pagina"^] | Descrive la sintassi e l'utilizzo dei comandi ONTAP 9.15.1 supportati. 
