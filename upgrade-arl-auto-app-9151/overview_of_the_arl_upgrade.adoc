...
summary: 'Scopri come funziona la procedura di aggiornamento dei controller introdotta in ONTAP 9.15.1 o versioni successive usando i comandi  `system controller replace`.' 
---
...
Dopo aver appreso la sequenza di aggiornamento ARL, link:prepare_nodes_for_upgrade.html["preparare i nodi per l'aggiornamento"].
