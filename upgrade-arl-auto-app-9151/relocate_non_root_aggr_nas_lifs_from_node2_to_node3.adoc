...
summary: 'Sposta gli aggregati non root del nodo2 sul nodo3 quando esegui l"aggiornamento ai controller introdotti in ONTAP 9.15.1 o versioni successive utilizzando i comandi  `system controller replace`.' 
---
...
Dopo aver spostato gli aggregati non root e i LIF dei dati NAS dal nodo2 al nodo3, link:relocate-failed-or-vetoed-aggr-node3.html["spostare gli aggregati non riusciti o bloccati a node3"].
