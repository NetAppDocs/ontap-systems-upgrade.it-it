...
summary: 'Abilita la coppia HA, verifica l"accesso allo storage di node3 e node4 e conferma la proprietà dell"aggregato dopo l"aggiornamento ai controller introdotti in ONTAP 9.15.1 o versioni successive utilizzando i comandi  `system controller replace`.' 
---
