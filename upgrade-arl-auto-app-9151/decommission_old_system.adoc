...
summary: 'Fai sapere a NetApp che il vecchio sistema non è più in funzione dopo l"aggiornamento ai controller introdotti in ONTAP 9.15.1 o versioni successive usando i comandi  `system controller replace`.' 
---
...
Dopo la dismissione del vecchio sistema, link:resume_snapmirror_operations.html["riprendere le operazioni di SnapMirror"].
