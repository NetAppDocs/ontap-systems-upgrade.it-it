...
summary: 'Informazioni sui problemi che potrebbero verificarsi quando si aggiornano i controller con ONTAP 9.15.1 o versione successiva tramite `system controller replace` i comandi.' 
---
