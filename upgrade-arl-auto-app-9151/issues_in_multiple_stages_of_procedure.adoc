...
summary: 'Informazioni sui problemi che potrebbero verificarsi durante l"aggiornamento ai controller introdotti in ONTAP 9.15.1 o versioni successive utilizzando i comandi  `system controller replace`.' 
---
