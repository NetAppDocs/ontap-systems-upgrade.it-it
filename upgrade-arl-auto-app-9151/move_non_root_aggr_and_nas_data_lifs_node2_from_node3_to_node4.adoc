...
summary: 'Verifica che i LIF dati NAS del nodo2 che si trovano su nodo3 vengano spostati da nodo3 a nodo4 quando esegui l"aggiornamento ai controller introdotti in ONTAP 9.15.1 o versioni successive usando i comandi  `system controller replace`.' 
---
