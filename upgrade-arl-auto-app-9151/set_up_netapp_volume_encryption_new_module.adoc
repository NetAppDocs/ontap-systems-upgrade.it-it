...
summary: 'Se necessario, configurare il nuovo modulo controller per NVE o NAE durante l"upgrade dei controller che eseguono ONTAP 9.15.1 o versione successiva utilizzando i `system controller replace` comandi.' 
---
