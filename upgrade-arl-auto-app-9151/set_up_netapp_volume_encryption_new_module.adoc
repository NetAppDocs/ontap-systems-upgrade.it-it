...
summary: 'Se necessario, configura il nuovo modulo controller per NVE o NAE quando esegui l"aggiornamento ai controller introdotti in ONTAP 9.15.1 o versioni successive usando  `system controller replace` comandi.' 
---
...
Dopo aver configurato la crittografia del volume o dell'aggregato NetApp sul nuovo modulo controller, link:decommission_old_system.html["decommissionare il vecchio sistema"].
