...
summary: 'Disabilita la coppia HA con node2 e spegni node1 quando esegui l"aggiornamento ai controller introdotti in ONTAP 9.15.1 o versioni successive usando i comandi  `system controller replace`.' 
---
= Ritirare il node1
:hardbreaks:
:allow-uri-read: 
...
Dopo aver disattivato il nodo1, link:prepare_for_netboot.html["preparare per netboot"].
