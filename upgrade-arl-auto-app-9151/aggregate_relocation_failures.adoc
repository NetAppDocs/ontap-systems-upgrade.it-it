...
summary: 'Risolvi i problemi relativi agli errori di riallocazione aggregata che potrebbero verificarsi quando usi i comandi  `system controller replace` per l"aggiornamento ai controller introdotti in ONTAP 9.15.1 o versioni successive.' 
---
