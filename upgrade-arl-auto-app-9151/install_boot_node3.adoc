...
. Se il sistema entra in un ciclo di riavvio con il messaggio `no disks found`, indica che si è verificato un problema con la riassegnazione del disco. Consultare link:troubleshoot_index.html["Risolvere i problemi"] per risolvere il problema.
