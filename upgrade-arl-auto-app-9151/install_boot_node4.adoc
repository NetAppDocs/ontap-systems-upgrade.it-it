...
. [[auto_check_4_step11]]su node4, vai al menu di avvio e usando 22/7, seleziona l'opzione nascosta `boot_after_controller_replacement`. Al prompt, immettere node2 per riassegnare i dischi di node2 a node4, come nell'esempio seguente.
+
