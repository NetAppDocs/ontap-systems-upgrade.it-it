...
summary: 'Sposta gli aggregati non root e le LIF dati NAS da node1 TB a node2 TB e sposta le risorse di node1 in node3 quando esegui l"upgrade dei controller con ONTAP 9.15.1 o versioni successive utilizzando i `system controller replace` comandi.' 
---
