...
summary: 'Spostare manualmente gli aggregati non riusciti o sottoposti a veto su node3 durante l"aggiornamento dei controller che eseguono ONTAP 9.15.1 o versioni successive utilizzando `system controller replace` comandi.' 
---
...
Dopo aver spostato gli aggregati non riusciti o bloccati sul nodo3, link:retire_node2.html["ritirare node2"].
