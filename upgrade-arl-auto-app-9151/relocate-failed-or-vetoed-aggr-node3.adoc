...
summary: 'Sposta manualmente gli aggregati non riusciti o bloccati sul nodo3 quando aggiorni ai controller introdotti in ONTAP 9.15.1 o versioni successive usando i comandi  `system controller replace`.' 
---
