...
summary: 'Quando aggiorni ai controller introdotti in ONTAP 9.15.1 o versioni successive, sposta manualmente gli aggregati non riusciti o bloccati sul nodo2 usando i comandi  `system controller replace`.' 
---
