...
summary: 'Spostare manualmente gli aggregati non riusciti o sottoposti a veto sul nodo 2 durante l"aggiornamento dei controller che eseguono ONTAP 9.15.1 o versioni successive utilizzando `system controller replace` comandi.' 
---
...
Dopo aver spostato gli aggregati non riusciti o rifiutati sul nodo2, link:retire_node1.html["ritirare node1"].
