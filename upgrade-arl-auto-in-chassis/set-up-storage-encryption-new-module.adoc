...
Dopo aver configurato la crittografia dell'archiviazione sul nuovo modulo controller, link:set-up-netapp-volum-encryption-new-module.html["Configurare la crittografia del volume o dell'aggregato NetApp sul nuovo modulo controller"].
