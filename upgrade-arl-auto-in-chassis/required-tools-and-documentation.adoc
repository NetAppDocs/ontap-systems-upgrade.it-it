...
Fare riferimento a link:other-references.html["Riferimenti"] per accedere all'elenco dei documenti di riferimento e dei siti di riferimento necessari per questo aggiornamento.

.Quali sono le prossime novità?
Dopo aver esaminato gli strumenti e la documentazione necessari, link:guidelines-for-upgrading-controllers-with-arl.html["Scopri le linee guida per l'aggiornamento dei controller"].
