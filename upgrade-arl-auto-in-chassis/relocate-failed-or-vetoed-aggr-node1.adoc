...
summary: Sposta manualmente gli aggregate non riusciti o bloccati su node1 quando usi ARL per aggiornare i modelli di controller nello stesso chassis. 
---
...
Dopo aver spostato gli aggregati non riusciti o bloccati sul nodo1, link:retire-node2.html["ritirare node2"].
