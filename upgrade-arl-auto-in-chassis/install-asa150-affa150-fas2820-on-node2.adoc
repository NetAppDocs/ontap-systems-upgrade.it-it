...
summary: Installare i moduli di sistema sostitutivi in node2 durante un aggiornamento ARL dei modelli di controller nello stesso chassis. 
---
= Installare il modulo controller ASA A150, AFF A150 o FAS2820 in node2
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Installare il modulo controller ASA A150, AFF A150 o FAS2820 ricevuto per l'aggiornamento in node2. Node2 è il controller B situato sul lato destro dello chassis quando si guardano i controller dal retro del sistema.
