...
Dopo aver verificato che i nuovi controller siano configurati correttamente, link:set-up-storage-encryption-new-module.html["Configurare la crittografia dell'archiviazione sul nuovo modulo controller"].
