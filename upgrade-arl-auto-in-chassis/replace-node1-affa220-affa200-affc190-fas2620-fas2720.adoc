...
---
= Sostituire il modulo controller node1 AFF A220, AFF A200, AFF C190, FAS2620 o FAS2720
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Sostituire il modulo controller node1 AFF A220, AFF A200, AFF C190, FAS2620 o FAS2720 con un modulo controller ASA A150, AFF A150 o FAS2820.
...
Per accedere ai componenti all'interno del controller node1, rimuovere il modulo controller dal sistema e quindi rimuovere il coperchio sul modulo controller.
...
Dopo aver installato il modulo controller ASA A150, AFF A150 o FAS2820, link:netboot-node1.html["netboot node1"].
