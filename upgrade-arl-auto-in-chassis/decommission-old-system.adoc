...
.Fasi
. Consultare link:other-references.html["Riferimenti"] per collegarsi al _NetApp Support Site_ ed effettuare il login.
...
Dopo la dismissione del vecchio sistema, link:resume-snapmirror-operations.html["riprendere le operazioni di SnapMirror"].
