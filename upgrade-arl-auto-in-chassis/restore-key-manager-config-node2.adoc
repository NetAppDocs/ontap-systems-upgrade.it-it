...
Dopo aver ripristinato la configurazione del key-manager sul nodo2, link:verify-rcf-configuration.html["verificare la configurazione RCF sugli switch del cluster"].
