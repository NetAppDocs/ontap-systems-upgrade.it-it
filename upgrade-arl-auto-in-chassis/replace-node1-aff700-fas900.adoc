...
---
= Sostituire i moduli controller e NVRAM del nodo1 AFF A700 o FAS9000
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Sostituire i moduli controller e NVRAM node1 AFF A700 o FAS9000 con i moduli controller e NVRAM ASA A900, AFF A900 o FAS9500.
...
Staccare e rimuovere il modulo controller node1 AFF A700 o FAS9000.
...
Sblocca e rimuovi il modulo NVRAM AFF A700 o FAS9000 del nodo1.
...
Installare, cablare e collegare il modulo NVRAM ASA A900, AFF A900 o FAS9500 nel nodo1.
...
== Passaggio 4: installa il modulo controller ASA A900, AFF A900 o FAS9500 in node1

Installare, cablare e collegare il modulo controller ASA A900, AFF A900 o FAS9500 in node1.
...
. Dopo aver interrotto AUTOBOOT, node1 si ferma al prompt LOADER. Se non si interrompe AUTOBOOT in tempo e node1 inizia l'avvio, attendere il prompt e premere Ctrl-C per accedere al menu di boot. Dopo che il nodo si è fermato al menu di boot, utilizzare l'opzione  `8` per riavviare il nodo e interrompere AUTOBOOT durante il riavvio.
...
Dopo aver installato i controller ASA A900, AFF A900 o FAS9500 e i moduli NVRAM, link:netboot-node1.html["netboot node1"].
