...
---
= Sostituire il modulo controller AFF A250 o AFF C250 del nodo1
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Sostituire il modulo controller node1 AFF A250 o AFF C250 con un modulo controller AFF A30, AFF A50, AFF C30 o AFF C60.
...
Per rimuovere il modulo controller node1, rimuovere il dispositivo di gestione dei cavi e sbloccare i fermi di bloccaggio. Quindi, rimuovere il modulo controller dallo chassis.
...
Dopo aver installato il modulo controller AFF A30, AFF A50, AFF C30 o AFF C60, link:netboot-node1.html["netboot node1"].
