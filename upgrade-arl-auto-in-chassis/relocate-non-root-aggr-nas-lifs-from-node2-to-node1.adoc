...
Dopo aver spostato gli aggregati non root e i LIF dei dati NAS dal nodo2 al nodo1, link:relocate-failed-or-vetoed-aggr-node1.html["spostare gli aggregati non riusciti o rifiutati al node1"].
