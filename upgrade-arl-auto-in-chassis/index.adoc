...
* Questa procedura è complessa e presuppone che tu abbia competenze avanzate di amministrazione ONTAP. Dovresti leggere e comprendere le link:guidelines_for_upgrading_controllers_with_arl.html["linee guida per l'aggiornamento dei controller"] e link:overview_of_the_arl_upgrade.html["Sequenza di aggiornamento ARL"] prima di iniziare l'aggiornamento.
