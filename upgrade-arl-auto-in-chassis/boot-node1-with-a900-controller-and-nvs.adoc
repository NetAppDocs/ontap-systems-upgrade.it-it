...
[role="lead"]
Node1 con i moduli sostitutivi è ora pronto per l'avvio. I moduli sostitutivi supportati sono elencati nella link:decide-to-use-the-aggregate-relocation-guide.html#supported-systems-in-chassis["matrice dei sistemi supportati"].
...
Dopo aver avviato node1 con i moduli di sistema sostitutivi, link:verify-node1-installation.html["verificare l'installazione del nodo1"].
