...
Dopo aver configurato la crittografia del volume o dell'aggregato NetApp sul nuovo modulo controller, link:decommission-old-system.html["decommissionare il vecchio sistema"].
