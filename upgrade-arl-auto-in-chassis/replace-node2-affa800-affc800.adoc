...
summary: Sostituire il modulo controller node2 AFF A800 o AFF C800 durante un aggiornamento ARL dei modelli di controller nello stesso chassis. 
---
= Sostituire il modulo controller AFF A800 o AFF C800 del nodo 2
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Sostituire il modulo controller node2 AFF A800 o AFF C800 con un modulo controller AFF A90, AFF A70 o AFF C80.

In questa fase, node2 è inattivo e tutti i dati sono gestiti da node1. È necessario assicurarsi di rimuovere solo il modulo controller di node2. Node2 è il controller B situato nell'alloggiamento inferiore dello chassis, guardando i controller dal retro del sistema. L'etichetta del controller si trova sullo chassis direttamente sopra il modulo controller.
...
Rimuovere il dispositivo di gestione dei cavi dal modulo node2 esistente e spostare leggermente il controller fuori dallo chassis.
...
Installare il modulo controller AFF A90 o AFF A70 ricevuto per l'aggiornamento in node2.
...
Dopo aver installato il modulo AFF A90 o AFF A70, link:netboot-node2.html["netboot node2"].
