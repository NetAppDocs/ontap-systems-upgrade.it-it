...
Dopo aver ripristinato la configurazione del key-manager sul nodo1 aggiornato, link:move-non-root-aggr-nas-lifs-node1-from-node2-to-upgraded-node1.html["Spostare gli aggregati non root di node1 e i LIF dei dati NAS da node2 al node1 aggiornato"].
