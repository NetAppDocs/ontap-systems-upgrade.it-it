...
* Se preferisci un metodo diverso per aggiornare l'hardware del controller e sei disposto a spostare i volumi, fai riferimento a link:other-references.html["Riferimenti"]_Aggiornamento tramite spostamento di volumi o storage_.


.Informazioni correlate
Consultare link:other-references.html["Riferimenti"] per collegarsi alla _ONTAP 9 Documentation_.

.Quali sono le prossime novità?
Dopo aver deciso di utilizzare questa procedura ARL, link:required-tools-and-documentation.html["Scopri gli strumenti e la documentazione necessari"].
