...
| link:verify-upgrade-hardware.html["Fase 1: Preparazione per l'aggiornamento"]  a| 
...
| link:relocate-non-root-aggr-and-nas-data-lifs-node1-node2.html["Fase 2: Trasferire le risorse e dismettere il node1"]  a| 
...
| link:relocate-non-root-aggr-nas-lifs-from-node2-to-node1.html["Fase 4: Trasferire le risorse e dismettere il node2"]  a| 
...
| link:install-aff-a30-a50-c30-c50-node2.html["Fase 5: Installare i moduli di sistema sostitutivi del nodo2"]  a| 
...
| link:cable-node2-for-shared-cluster-HA-storage.html["Fase 6: Punto di avvio2 con i moduli di sistema sostitutivi"]  a| 
...
Dopo aver appreso la sequenza di aggiornamento ARL, link:verify-upgrade-hardware.html["verificare l'aggiornamento hardware"].
