...
+
Inserisci la passphrase e le informazioni di backup che hai annotato in precedenza nella procedura. Vedi link:manage-storage-encryption-using-okm.html["Gestire la crittografia dello storage utilizzando Onboard Key Manager"].
