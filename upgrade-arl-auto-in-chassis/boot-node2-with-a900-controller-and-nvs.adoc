...
[role="lead"]
Node2 con i moduli sostitutivi è ora pronto per l'avvio.  I moduli sostitutivi supportati sono elencati inlink:decide_to_use_the_aggregate_relocation_guide.html#supported-systems-in-chassis["matrice dei sistemi supportati"] .
