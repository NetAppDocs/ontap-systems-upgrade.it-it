...
---
= Installare il modulo AFF A90 o AFF A70 in node2
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Installare il modulo controller AFF A90 o AFF A70 ricevuto per l'aggiornamento in node2. Node2 è il controller B situato nell'alloggiamento inferiore dello chassis, guardando i controller dal retro del sistema.
