...
summary: Collega le connessioni del cluster, della coppia HA, dello storage e dei dati che erano precedentemente collegate al nodo AFF A800 node2 al nuovo nodo AFF A90 o AFF A70 appena installato. 
---
...
Dopo aver cablato il nodo2 per il cluster-HA condiviso e lo storage, link:boot-node2-with-a900-controller-and-nvs.html["Avviare il nodo2 con i moduli di sistema sostitutivi"].
