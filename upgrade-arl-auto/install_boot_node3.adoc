...
* Se si dispone di un sistema con una configurazione FC o UTA/UTA2,link:set_fc_or_uta_uta2_config_on_node3.html["imposta la configurazione FC o UTA/UTA2 sul nodo 3"] .
* Se non si dispone di una configurazione FC o UTA/UTA2,link:reassign-node1-disks-to-node3.html#reassign-node1-node3-step1["riassegnare i dischi del nodo 1 al nodo 3"] in modo che node3 possa riconoscere i dischi di node1.
* Se si dispone di una configurazione MetroCluster ,link:reassign-node1-disks-to-node3.html#reassign-node1-node3-step1["riassegnare i dischi del nodo 1 al nodo 3"] .
