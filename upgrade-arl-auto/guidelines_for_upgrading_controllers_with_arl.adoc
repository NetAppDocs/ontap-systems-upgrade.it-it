...
* A controllori entry level con dischi interni, ad esempio: un FAS2750.
+
...
Se si verificano problemi durante l'aggiornamento dei controller, fare riferimento alink:aggregate_relocation_failures.html["Risolvere i problemi"] sezione.  Le informazioni sui guasti che possono verificarsi sono elencate in base alla fase della procedura nellink:overview_of_the_arl_upgrade.html["Sequenza di aggiornamento ARL"] .
