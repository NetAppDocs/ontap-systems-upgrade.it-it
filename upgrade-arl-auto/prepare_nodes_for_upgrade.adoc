...
[NOTE]
====
Puoi eseguire questo comando solo con privilegi di livello avanzato:
...
Per informazioni dettagliate sulle licenze ONTAP, fare riferimento a link:other_references.html["Riferimenti"] per collegarsi al _System Administration Reference_.
