...
. [[step8]]Salta questa sezione e vai alink:reassign-node2-disks-to-node4.html["Riassegnare dischi da node2 TB a node4 TB"] se node4 non ha una scheda UTA/UTA2 o porte UTA/UTA2 integrate.
