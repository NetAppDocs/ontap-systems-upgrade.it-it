...
. [[fase 29]] per la configurazione MetroCluster, i sistemi V-Series e i sistemi con software di virtualizzazione FlexArray collegati agli array di storage, visitare il sito link:set_fc_or_uta_uta2_config_node4.html#auto_check_node4_step15["Controllare e configurare le porte UTA/UTA2 sul nodo 4, passaggio 15"].
