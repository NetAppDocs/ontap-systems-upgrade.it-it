...
Dopo aver configurato la crittografia dell'archiviazione sul nuovo modulo controller, link:set_up_netapp_encryption_on_new_controller.html["Configurare la crittografia del volume o dell'aggregato NetApp sul nuovo modulo controller"].
