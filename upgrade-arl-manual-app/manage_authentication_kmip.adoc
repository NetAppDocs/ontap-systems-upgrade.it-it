...
Dopo aver gestito l'autenticazione tramite server KMIP, link:ensure_controllers_set_up_correctly.html["confermare che i nuovi controller siano configurati correttamente"].
