...
Se node3 non dispone di porte FC integrate, porte UTA/UTA2 integrate o una scheda UTA/UTA2 (ad esempio, sistemi AFF e FAS introdotti a partire da ONTAP 9.15.1) e si sta aggiornando un sistema con dischi di archiviazione, è possibile passare alla sezionelink:map_ports_node1_node3.html["Mappare le porte dal nodo 1 al nodo 3"] .
...
Dopo aver impostato la configurazione FC o UTA/UTA2 sul nodo3, link:map_ports_node1_node3.html["mappa le porte dal nodo1 al nodo3"].
