...
Per ulteriori informazioni sui comandi di rilocazione degli aggregati di archiviazione, fare riferimento a link:other_references.html["Riferimenti"] _Gestione di dischi e aggregati con la CLI_ e al _ONTAP 9 Command reference_.
...
Dopo aver spostato gli aggregati non root del nodo2 dal nodo3 al nodo4, link:manage_authentication_kmip.html["Gestire l'autenticazione tramite server KMIP"].
