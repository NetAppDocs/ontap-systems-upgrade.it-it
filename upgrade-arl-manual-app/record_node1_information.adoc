...
+
In una fase successiva della procedura, i domini di broadcast dovranno essere mappati sulle nuove porte del nuovo controller.
...
Dopo aver registrato le informazioni del nodo1, link:retire_node1.html["ritirare node1"].
