...
summary: Far sapere a NetApp che il vecchio sistema non è più in funzione dopo aver completato un aggiornamento ARL manuale sui controller che eseguono ONTAP 9.8 o versioni successive. 
---
...
Dopo la dismissione del vecchio sistema, link:resume_snapmirror_ops.html["riprendere le operazioni di SnapMirror"].
