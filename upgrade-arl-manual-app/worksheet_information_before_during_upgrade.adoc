...
Dopo aver registrato le informazioni originali del nodo, link:determine_aggregates_on_internal_drives.html["determinare se il controller dispone di aggregati su unità disco interne"].
