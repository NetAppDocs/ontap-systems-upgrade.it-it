...
Dopo aver determinato se il controller dispone di aggregati su unità disco interne, link:prepare_nodes_for_upgrade.html["preparare i nodi per l'aggiornamento"].
