...
+
Il  `disk reassign` comando riassegna solo i dischi di cui  `_node2_sysid_` è il proprietario corrente.
...
Dopo aver installato e avviato node4, link:set_fc_uta_uta2_config_node4.html["imposta la configurazione FC o UTA/UTA2 sul nodo 4"].
