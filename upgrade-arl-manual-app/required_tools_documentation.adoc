...
Dopo aver esaminato gli strumenti e la documentazione necessari, link:worksheet_information_before_during_upgrade.html["registrare le informazioni originali del nodo da utilizzare durante l'aggiornamento"].
