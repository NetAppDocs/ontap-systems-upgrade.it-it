...
Per ulteriori informazioni sui comandi di rilocazione degli aggregati di archiviazione, vai a link:other_references.html["Riferimenti"] per collegarti a _Gestione di dischi e aggregati con la CLI_ e al _ONTAP 9 Command reference_.
...
Dopo aver spostato gli aggregati non root dal nodo2 al nodo3, link:move_nas_lifs_node2_node3.html["spostare i LIF dei dati NAS di proprietà del nodo2 sul nodo3"].
