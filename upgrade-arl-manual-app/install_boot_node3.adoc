...
+
Inserisci la passphrase e le informazioni di backup che hai annotato in precedenza nella procedura. Vedi link:manage_authentication_okm.html["Gestire le chiavi di autenticazione utilizzando Onboard Key Manager"].
...
. Premi CTRL-C per visualizzare il menu di boot.
...
Dopo aver installato e avviato node3, link:set_fc_uta_uta2_config_node3.html["imposta la configurazione FC o UTA/UTA2 sul nodo 3"].
